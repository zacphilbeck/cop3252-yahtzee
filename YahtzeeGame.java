...
public class YahtzeeGame extends JFrame
{
	...
	{
		System.out.println("MakeScoreCard()");
		AddDicePanel();
		DiceFunctionality();
	...
	{
		System.out.println("UpdatePlayerTurn");
		if(p1turn == true)
		{
			p1turn = false;
			p2turn = true;
	...
	{
		System.out.println("NumberChoosing()");
		...
		if(onesJButton.isSelected())
			onesJButton.setSelected(false);
		if(twosJButton.isSelected())
			twosJButton.setSelected(false);
		if(threesJButton.isSelected())
			threesJButton.setSelected(false);
		if(foursJButton.isSelected())
			foursJButton.setSelected(false);
		if(fivesJButton.isSelected())
			fivesJButton.setSelected(false);
		if(sixesJButton.isSelected())
			sixesJButton.setSelected(false);
		if(threeofkindJButton.isSelected())
			threeofkindJButton.setSelected(false);
		if(fourofkindJButton.isSelected())
			fourofkindJButton.setSelected(false);
		if(fullhouseJButton.isSelected())
			fullhouseJButton.setSelected(false);
		if(SMStraightJButton.isSelected())
			SMStraightJButton.setSelected(false);
		if(LGStraightJButton.isSelected())
			LGStraightJButton.setSelected(false);
		if(chanceJButton.isSelected())
			chanceJButton.setSelected(false);
		if(yahtzeeJButton.isSelected())
			yahtzeeJButton.setSelected(false);
	...
	public void AddDicePanel() {
		System.out.println("AddDicePanel()");
	...
	public void DiceFunctionality() {
		System.out.println("DiceFunctionality()");
	...
	{
		System.out.println("NumberofPlayersActionPerformed()");
